...
export function applyTheme(theme: Theme) {
    ...
    cssVars({
        variables: {
            ...
            'center-channel-bg-64': changeOpacity(theme.centerChannelBg, 1),
            'center-channel-color-64': changeOpacity(theme.centerChannelColor, 1),
            ...
            'button-bg-64': changeOpacity(theme.buttonBg, 1),
            'button-color-64': changeOpacity(theme.buttonColor, 1),
